...
use VisualDesignerManager\Admin\DiagnosticsController;
...
use VisualDesignerManager\Admin\PageLifecycleController;
...
final class Plugin
{
    ...
    public static function boot(): void
    {
        ...
        PageLifecycleController::register();
        DesignerController::register();
        DesignerParityController::register();
        DiagnosticsController::register();
