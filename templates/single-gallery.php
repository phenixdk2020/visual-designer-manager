<?php
/**
 * Canonical VDM V2 Gallery shell.
 */

declare(strict_types=1);

use VisualDesignerManager\Frontend\GalleryRenderer;
...
<body <?php body_class('vdm-site-shell-active vdm-gallery-shell-active'); ?>>
...
<div class="vdm-site-shell" style="<?php echo esc_attr($style); ?>">
    ...
    <main class="vdm-site-main" id="main" role="main">
        <div class="vdm-site-region">
            <?php echo GalleryRenderer::renderDetail($postId); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
        </div>
    </main>
