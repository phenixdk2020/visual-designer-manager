<?php
/**
 * Canonical VDM V2 Event shell.
 */

declare(strict_types=1);

use VisualDesignerManager\Frontend\EventRenderer;
...
<body <?php body_class('vdm-site-shell-active vdm-event-shell-active'); ?>>
...
<div class="vdm-site-shell" style="<?php echo esc_attr($style); ?>">
    ...
    <main class="vdm-site-main" id="main" role="main">
        <div class="vdm-site-region">
            <?php echo EventRenderer::renderDetail($postId); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
        </div>
    </main>
