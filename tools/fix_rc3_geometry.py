...
# Temporary release applicator: preserves RC.1 canonical geometry while RC.2 fine geometry remains authoritative for rendering. Re-run after parity contract version hardening.
